...
import { createData } from "../app/actions/createAction";
import { editData } from "../app/actions/editAction";

const CreateCLientModal = ({ control, showForm, setShowForm, data }) => {
  ...
  const handleSubmit = async (values) => {
    control.option === "edit"
      ? dispatch(editData({ data, edit: { id: control.id, ...values } }))
      : dispatch(createData({ data, values }));
  };
  return (
    <div className="py-64">
      <div
